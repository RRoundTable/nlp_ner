...
if __name__ == '__main__':
    ...
    parser.add_argument('--epochs', type=int, default=50, required=False, help='Epoch value')
    parser.add_argument('--batch_size', type=int, default=30, required=False, help='Batch size')
    parser.add_argument('--learning_rate', type=float, default=0.005, required=False, help='Set learning rate')
    parser.add_argument('--keep_prob', type=float, default=0.7, required=False, help='Dropout_rate')

    parser.add_argument("--word_embedding_size", type=int, default=20, required=False, help='Word, WordPos Embedding Size')
    parser.add_argument("--char_embedding_size", type=int, default=15, required=False, help='Char Embedding Size')
    ...
    parser.add_argument('--char_lstm_units', type=int, default=70, required=False, help='Hidden unit size for Char rnn')
